...
```
1. **Path to where your custom models are defined** Here provide the path to where you have defined your custom models. TODO: Add link to how to define custom models.
...
## Stage 4: Commincation

Hibayes support two methods of communicating results, plots and tables. Again there are some default plots and tables along with the option of providing your own methods.
